...
import skipBoimg from "../assets/skipBo2.jpg";
...
function About() {
  return (
    <div className="about">
      <div
        className="aboutTop"
        style={{ backgroundImage: `url(${skipBoimg})` }}
      ></div>
      <div className="aboutBottom">
        <h1> HOW TO PLAY?</h1>
        <h2> OBJECT</h2>
        <p>
          Be the first player to play every card in your Stock
          pile, by playing all of your cards in numerical order, 1 to 12.
          For two to six players ages seven and up. 
        </p>
        <h2> Beginning Play</h2>
        <p>
          Shuffle the deck. Each player draws a card.
          The person with the highest card is the dealer. The dealer
          deals 30 cards to each player if there are two to four players.
          In five to six player games, each player is dealt 20 cards.
          These cards are dealt face down and form each player’s Stock pile. Once all Stock piles
          have been dealt, each player flips the top card of their Stock pile right side up and places
          it on top of the pile. The remaining cards not dealt are placed face down on the table to
          form the draw pile. 
        </p>
        <h2> Playing Skip-Bo</h2>
        <p>
        ...
        <p>
          Choose a point total to play to (500 is recommended to start). The
